...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00 => PORTC: 0x00',
    ...
    {'description': 'PINA: 0x00, PINB: 0x01 => PORTC: 0x01',
    ...
    {'description': 'PINA: 0x81, PINB: 0x81 => PORTC: 0x04',
    'steps': [ {'inputs': [('PINA',0x81),('PINB',0x81)], 'iterations': 5 } ],
    'expected': [('PORTC', 0x04)],
    },
    {'description': 'PINA: 0x18, PINB: 0x18 => PORTC: 0x04',
    'steps': [ {'inputs': [('PINA',0x18),('PINB',0x18)], 'iterations': 5 } ],
    'expected': [('PORTC', 0x04)],
    },
    {'description': 'PINA: 0xFF, PINB: 0x00 => PORTC: 0x08',
    'steps': [ {'inputs': [('PINA',0xFF),('PINB',0x00)], 'iterations': 5 } ],
    'expected': [('PORTC', 0x08)],
    },
    {'description': 'PINA: 0x00, PINB: 0xFF => PORTC: 0x08',
